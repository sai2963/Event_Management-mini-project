...
export default function EventFetcherData({ EventId, children }) {
  const [exploreEventData, setExploreEventData] = useState(null);
  ...
  return children(exploreEventData, null);
}